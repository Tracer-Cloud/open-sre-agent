...
from gateway.core.telegram_poller.poller import TelegramPoller, _decode_telegram_response
...
@patch("gateway.core.telegram_poller.poller.time.sleep")
@patch("gateway.core.telegram_poller.poller.httpx.get")
def test_poll_once_conflict_is_debug_not_warning(
    ...
    caplog.set_level(logging.DEBUG, logger="gateway.core.telegram_poller.poller")
