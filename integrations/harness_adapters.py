...
def _register_prompt_fragments() -> None:
    ...
    from integrations.posthog_mcp.gather_prompt import posthog_mcp_gather_prompt_fragment
    ...
    register_gather_prompt_fragment(posthog_mcp_gather_prompt_fragment)
