...
def _save_remote_base_url(client: RemoteAgentClient) -> None:
    from surfaces.cli.wizard.store import save_remote_url

    save_remote_url(client.base_url)

    from surfaces.cli.wizard.store import load_named_remotes, save_named_remote
...
def _render_remote_health_report(report: dict[str, Any]) -> None:
    ...
    from surfaces.interactive_shell.ui.health import status_badge
