...
def guardrails_init() -> None:
    ...
    from platform.safety.guardrails.cli import cmd_init
...
def guardrails_test(text: str) -> None:
    ...
    from platform.safety.guardrails.cli import cmd_test
...
def audit(limit: int) -> None:
    ...
    from platform.safety.guardrails.cli import cmd_audit
...
def guardrails_rules() -> None:
    ...
    from platform.safety.guardrails.cli import cmd_rules
