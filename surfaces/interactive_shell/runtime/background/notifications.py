...
Channel selection lives in ``platform.delivery.notifications``. This runs the registration
...
def deliver_background_notifications(
    *,
    ...
    from platform.delivery.notifications.outbound_dispatch import dispatch_background_notifications
