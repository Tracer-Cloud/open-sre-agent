...
def test_run_happy_path() -> None:
    ...
    with patch("tools.eks_list_clusters_tool.EKSClient", return_value=mock_client):
...
def test_run_forwards_credentials_to_eks_client() -> None:
    ...
    with patch("tools.eks_list_clusters_tool.EKSClient", return_value=mock_client) as cls:
