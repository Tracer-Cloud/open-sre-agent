...
from tools.VercelDeploymentStatusTool import VercelDeploymentStatusTool
...
def test_run_returns_failed_deployments_for_error_state(tool: VercelDeploymentStatusTool) -> None:
    ...
    with patch("tools.VercelDeploymentStatusTool.make_vercel_client", return_value=mock_client):
