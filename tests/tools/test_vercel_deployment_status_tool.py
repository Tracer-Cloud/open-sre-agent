...
from tools.vercel_deployment_status_tool import VercelDeploymentStatusTool
...
def test_run_returns_failed_deployments_for_error_state(tool: VercelDeploymentStatusTool) -> None:
    ...
    with patch("tools.vercel_deployment_status_tool.make_vercel_client", return_value=mock_client):
