...
from tools.grafana_service_names_tool import query_grafana_service_names
...
def test_run_no_client() -> None:
    ...
    with patch("tools.grafana_service_names_tool._resolve_grafana_client", return_value=mock_client):
