...
from tools.PrefectWorkerHealthTool import PrefectWorkerHealthTool
...
def test_run_returns_unavailable_on_api_failure(tool: PrefectWorkerHealthTool) -> None:
    ...
    with patch("tools.PrefectWorkerHealthTool.make_prefect_client", return_value=mock_client):
...
def test_run_returns_unavailable_when_client_none(tool: PrefectWorkerHealthTool) -> None:
    with patch("tools.PrefectWorkerHealthTool.make_prefect_client", return_value=None):
        result = tool.run(api_url="http://localhost:4200/api")
