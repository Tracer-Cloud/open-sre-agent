...
from tools.MariaDBStatusTool import get_mariadb_global_status
...
def test_run_happy_path() -> None:
    ...
    with patch("tools.MariaDBStatusTool.get_global_status", return_value=fake_result):
...
def test_run_error_propagated() -> None:
    with patch(
        "tools.MariaDBStatusTool.get_global_status",
