...
from tools.prefect_flow_runs_tool import PrefectFlowRunsTool
...
def test_run_returns_unavailable_when_client_none() -> None:
    tool = PrefectFlowRunsTool()
    with patch("tools.prefect_flow_runs_tool.make_prefect_client", return_value=None):
...
def test_run_happy_path() -> None:
    ...
    with patch("tools.prefect_flow_runs_tool.make_prefect_client", return_value=mock_client):
