...
from tools.GrafanaAlertRulesTool import query_grafana_alert_rules
...
def test_run_no_client() -> None:
    ...
    with patch("tools.GrafanaAlertRulesTool._resolve_grafana_client", return_value=mock_client):
