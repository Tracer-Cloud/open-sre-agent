...
def test_run_happy_path() -> None:
    ...
    with patch("tools.EKSEventsTool.build_k8s_clients", return_value=(mock_core_v1, MagicMock())):
...
def test_run_handles_exception() -> None:
    with patch("tools.EKSEventsTool.build_k8s_clients", side_effect=Exception("api error")):
        result = get_eks_events(
            cluster_name="c1", namespace="default", role_arn="arn:aws:iam::123:role/r"
        )
