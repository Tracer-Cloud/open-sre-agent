...
from tools.MongoDBAtlasEventsTool import get_mongodb_atlas_cluster_events
...
def test_run_happy_path() -> None:
    ...
    with patch("tools.MongoDBAtlasEventsTool.get_cluster_events", return_value=fake_result):
...
def test_run_error_propagated() -> None:
    with patch(
        "tools.MongoDBAtlasEventsTool.get_cluster_events",
