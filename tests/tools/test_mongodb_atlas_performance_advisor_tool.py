...
from tools.MongoDBAtlasPerformanceAdvisorTool import get_mongodb_atlas_performance_advisor
...
def test_run_happy_path() -> None:
    ...
    with patch(
        "tools.MongoDBAtlasPerformanceAdvisorTool.get_performance_advisor",
