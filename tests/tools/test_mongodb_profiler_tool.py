...
from tools.MongoDBProfilerTool import get_mongodb_profiler_data
...
def test_run_happy_path() -> None:
    ...
    with patch("tools.MongoDBProfilerTool.get_profiler_data", return_value=fake_result):
...
def test_run_error_propagated() -> None:
    with patch(
        "tools.MongoDBProfilerTool.get_profiler_data",
