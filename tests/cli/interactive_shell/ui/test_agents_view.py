...
from cli.interactive_shell.ui import agents_view as agents_view_mod
...
def _clear_sampler_module_state() -> None:
    ...
    - :data:`app.tools.fleet_monitoring.sampler._latest` (probe snapshots dict)
    - :data:`app.tools.fleet_monitoring.token_rate.TOKEN_RATE_TRACKER` (per-PID deque)
    - :data:`app.tools.fleet_monitoring.sampler._TickCache.registry_snapshot` and
