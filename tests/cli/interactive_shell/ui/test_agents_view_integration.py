...
The only stubs are :func:`app.tools.fleet_monitoring.probe.cwd_for_pid` and
...
from app.tools.fleet_monitoring.registry import AgentRecord
from app.tools.fleet_monitoring.token_rate import TOKEN_RATE_TRACKER
from app.tools.fleet_monitoring.token_sources import claude_code as claude_source_mod
from app.tools.fleet_monitoring.token_sources import codex as codex_source_mod
...
def test_claude_code_end_to_end_renders_real_tokens_and_cost(
    ...
    monkeypatch.setattr(
        "app.tools.fleet_monitoring.token_sources.claude_code.cwd_for_pid",
    ...
    monkeypatch.setattr(
        "app.tools.fleet_monitoring.token_sources.claude_code.open_files_for_pid",
        lambda _pid: (session,),
    )
    ...
    monkeypatch.setattr(
        "app.tools.fleet_monitoring.sampler.get_token_source",
    ...
    monkeypatch.setattr("app.tools.fleet_monitoring.sampler.AgentRegistry", _Registry)
...
def test_codex_end_to_end_renders_real_tokens_and_cost(
    ...
    monkeypatch.setattr(
        "app.tools.fleet_monitoring.token_sources.codex.started_at_for_pid",
    ...
    monkeypatch.setattr(
        "app.tools.fleet_monitoring.token_sources.codex.open_files_for_pid",
        lambda _pid: (rollout,),
    )
