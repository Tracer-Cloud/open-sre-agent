...
from utils.whatsapp_delivery import (
...
def test_post_whatsapp_message_twilio_success(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("utils.whatsapp_delivery.httpx.post", _fake_post)
...
def test_post_whatsapp_message_twilio_api_error(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("utils.whatsapp_delivery.httpx.post", lambda *_a, **_kw: _Resp())
...
def test_send_whatsapp_report_success(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("utils.whatsapp_delivery.post_whatsapp_message_twilio", _fake_post)
