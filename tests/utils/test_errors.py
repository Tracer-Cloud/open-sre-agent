"""Tests for utils.errors helpers."""
...
class TestReportException:
    def test_logs_and_captures(self) -> None:
        ...
        with patch("utils.errors.capture_exception") as mock_cap:
    ...
    def test_warning_severity(self) -> None:
        ...
        with patch("utils.errors.capture_exception"):
...
class TestReportAndSwallow:
    def test_swallows_matching_exception(self) -> None:
        mock_log = _mock_logger()
        with (
            patch("utils.errors.capture_exception"),
    ...
    def test_calls_report_exception_on_match(self) -> None:
        ...
        with (
            patch("utils.errors.capture_exception") as mock_cap,
