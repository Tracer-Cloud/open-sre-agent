...
from utils.smtp_delivery import (
...
def test_verify_smtp_connection_uses_starttls(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("utils.smtp_delivery.smtplib.SMTP", _return_fake_client(fake_client))
...
def test_send_smtp_report_sends_plain_text_email(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(
        "utils.smtp_delivery.smtplib.SMTP_SSL",
