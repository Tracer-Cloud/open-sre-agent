...
from app.tools.fleet_monitoring import bus as bus_module
from app.tools.fleet_monitoring.bus import (
    BUS_SCHEMA_VERSION,
    BusMessage,
    BusServer,
    _pid_file_for,
...
class TestPublishSubscribe:
    ...
    def test_subscriber_disconnects_on_oversized_unterminated_stream(self, sock_path: Path) -> None:
        ...
        from app.tools.fleet_monitoring.bus import _MAX_FRAME_BYTES, BusServer, subscribe
            ...
            child = subprocess.run(
                [
                    ...
                    textwrap.dedent(
                        f"""
                        from pathlib import Path
                        from app.tools.fleet_monitoring import bus
