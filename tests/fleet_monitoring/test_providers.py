"""Tests for ``app.tools.fleet_monitoring.providers.provider_for`` canonical resolution."""

from __future__ import annotations

from app.tools.fleet_monitoring.providers import provider_for, provider_from_command
