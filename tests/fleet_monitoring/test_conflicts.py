"""Direct unit tests for app/tools/fleet_monitoring/conflicts.py."""

from __future__ import annotations

from app.tools.fleet_monitoring.conflicts import FileWriteConflict, WriteEvent, detect_conflicts
