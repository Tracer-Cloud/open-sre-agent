"""Tests for platform_services/guardrails/stream.py.
...
from platform_services.guardrails.stream import GuardrailStream
...
def stub_capture(monkeypatch: pytest.MonkeyPatch) -> list[dict[str, Any]]:
    ...
    monkeypatch.setattr("platform_services.guardrails.stream.capture_agent_secret_detected", _stub)
    return calls
