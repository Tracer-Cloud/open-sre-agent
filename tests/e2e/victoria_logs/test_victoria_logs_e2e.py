...
class TestVictoriaLogsToolAvailability:
    ...
    def test_tool_importable(self) -> None:
        from tools.victoria_logs_tool import VictoriaLogsTool, victoria_logs_query
    ...
    def test_tool_unavailable_without_source(self) -> None:
        from tools.victoria_logs_tool import victoria_logs_query
    ...
    @patch("tools.victoria_logs_tool.make_victoria_logs_client")
