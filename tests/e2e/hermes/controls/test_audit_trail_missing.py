...
def test_audit_trail_missing() -> None:
    state = run_hermes_scenario("042-audit-trail-missing")
    ...
    assert "signature" in response or "hash chain" in response or "tamper" in response
