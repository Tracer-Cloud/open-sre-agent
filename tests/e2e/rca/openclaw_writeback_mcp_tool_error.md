...
with patch("utils.openclaw_delivery.call_openclaw_tool", side_effect=_failing_tool):
    from utils.openclaw_delivery import send_openclaw_report
    from unittest.mock import patch as _p
    with _p("utils.openclaw_delivery.openclaw_runtime_unavailable_reason", return_value=None):
        state = {
