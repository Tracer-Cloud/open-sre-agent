"""Tests for platform.deployment_ec2.ec2.launch_instance block device mapping."""
...
from platform.deployment_ec2.ec2 import launch_instance


@patch("platform.deployment_ec2.ec2.get_boto3_client")
