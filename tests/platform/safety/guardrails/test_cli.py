...
from platform.safety.guardrails.cli import cmd_audit, cmd_init, cmd_rules, cmd_test
...
class TestCmdTest:
    def test_no_config_shows_message(
        ...
        monkeypatch.setattr(
            "platform.safety.guardrails.cli.get_default_rules_path",
    ...
    def test_shows_matches(
        ...
        monkeypatch.setattr("platform.safety.guardrails.cli.get_default_rules_path", lambda: config)
...
class TestCmdAudit:
    def test_shows_entries(
        ...
        monkeypatch.setattr("platform.safety.guardrails.cli.AuditLogger", lambda: audit)
