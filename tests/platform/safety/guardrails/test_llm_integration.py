...
from platform.safety.guardrails.engine import GuardrailBlockedError, reset_guardrail_engine
...
class TestLLMClientGuardrails:
    def test_redacts_before_api_call(self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        monkeypatch.setattr(
            "platform.safety.guardrails.rules.get_default_rules_path", lambda: config
        )
