...
from platform.deployment.ec2.config import GATEWAY_AMI_GIT_REF_ENV
from platform.deployment.ec2.telegram_gateway import build_server_image as image_module
