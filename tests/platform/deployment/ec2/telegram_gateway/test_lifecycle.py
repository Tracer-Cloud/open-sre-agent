...
import platform.deployment.ec2.telegram_gateway.stack as stack_module
from platform.deployment.ec2.config import GATEWAY_AMI_DESTROY_PURGE_ENV, GATEWAY_AMI_ID_ENV
from platform.deployment.ec2.telegram_gateway import lifecycle as lifecycle_module
