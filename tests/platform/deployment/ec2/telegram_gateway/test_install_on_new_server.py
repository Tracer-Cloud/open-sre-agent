...
import platform.deployment.ec2.telegram_gateway.install_on_new_server as install_module
from platform.deployment.ec2.config import EC2_UBUNTU_ROOT_DEVICE_NAME
