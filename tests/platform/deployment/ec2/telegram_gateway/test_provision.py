...
from platform.deployment.ec2.telegram_gateway import provision as provision_module
from platform.deployment.ec2.telegram_gateway.provision import provision_gateway_via_ssm

_INSTANCE_ID = "i-gateway1234567890"


@patch("platform.deployment.ec2.telegram_gateway.provision.run_ssm_shell_command")
...
@patch("platform.deployment.ec2.telegram_gateway.provision.run_ssm_shell_command")
@patch("platform.deployment.ec2.telegram_gateway.provision.time.sleep", return_value=None)
