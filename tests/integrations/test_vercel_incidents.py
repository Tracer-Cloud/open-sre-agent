...
def test_cmd_vercel_incidents_json_outputs_incidents(monkeypatch, capsys) -> None:
    ...
    monkeypatch.setattr("app.cli.interactive_shell.data_store.context._root_obj", lambda: {"json": True})
...
def test_cmd_vercel_incidents_exits_on_api_error(monkeypatch, capsys) -> None:
    ...
    monkeypatch.setattr("app.cli.interactive_shell.data_store.context._root_obj", lambda: {"json": False})
    monkeypatch.setattr(
