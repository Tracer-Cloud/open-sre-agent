...
POSTHOG_BASE_URL_ENV = "POSTHOG_BASE_URL"
POSTHOG_PROJECT_ID_ENV = "POSTHOG_PROJECT_ID"
POSTHOG_PERSONAL_API_KEY_ENV = "POSTHOG_PERSONAL_API_KEY"
POSTHOG_TIMEOUT_SECONDS_ENV = "POSTHOG_TIMEOUT_SECONDS"
