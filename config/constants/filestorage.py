...
# Opt into client-side encryption of every synced object.
REMOTE_SYNC_ENCRYPTION_ENV = "OPENSRE_REMOTE_SYNC_ENCRYPTION"
# Ambient encryption passphrase. Never persisted by opensre.
