...
from cli.interactive_shell.routing.handle_message_with_agent.orchestration.llm_action_planner.prompting import (
    _system_prompt,
)
...
def test_call_llm_prefixes_fallback_provider_context(monkeypatch) -> None:
    ...
    from cli.interactive_shell.routing.handle_message_with_agent.orchestration.llm_action_planner.llm_client import (  # noqa: E501
        _call_llm,
    )
