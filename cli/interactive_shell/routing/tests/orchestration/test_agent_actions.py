...
import cli.interactive_shell.routing.handle_message_with_agent.orchestration.action_executor as action_executor
import cli.interactive_shell.routing.handle_message_with_agent.orchestration.agent_actions as agent_actions
...
from cli.interactive_shell.routing.handle_message_with_agent.orchestration import (
...
from cli.interactive_shell.shell import execution as shell_execution
...
def test_execute_cli_actions_counts_planned_and_executed(monkeypatch: object) -> None:
    ...
    monkeypatch.setattr(
        "platform_services.analytics.cli.capture_terminal_actions_planned",
        lambda *, planned_count, has_unhandled_clause: captured_planned.append(
            (planned_count, has_unhandled_clause)
        ),
    )
    monkeypatch.setattr(
        "platform_services.analytics.cli.capture_terminal_actions_executed",
