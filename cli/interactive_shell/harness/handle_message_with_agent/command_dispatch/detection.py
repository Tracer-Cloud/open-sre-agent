...
from cli.interactive_shell.harness.handle_message_with_agent.command_dispatch.catalog import (
    BARE_COMMAND_ALIAS_MAP,
    BARE_COMMAND_ALIASES,
    BARE_COMMAND_ALIASES_WITH_ARGS,
)
from cli.interactive_shell.harness.handle_message_with_agent.orchestration.intent_parser import (
    is_single_edit_typo,
