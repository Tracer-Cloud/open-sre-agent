...
def uninstall_command(local_yes: bool) -> None:
    ...
    from cli.interactive_shell.state.data_store.uninstall import run_uninstall
...
def update_command(check_only: bool, local_yes: bool) -> None:
    ...
    from cli.interactive_shell.state.data_store.update import run_update
...
def _run_service_investigation(
    *,
    ...
    from cli.interactive_shell.state.data_store.args import write_json
    from cli.interactive_shell.utils.error_handling.errors import OpenSREError
