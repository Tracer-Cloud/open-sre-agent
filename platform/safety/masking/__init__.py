...
user-facing output. Complementary to ``platform/safety/guardrails`` which performs
...
from platform.safety.masking.detectors import DetectedIdentifier, find_identifiers
from platform.safety.masking.policy import ALL_KINDS, IdentifierKind, MaskingPolicy
