...
``platform.scheduling.scheduler`` must not import ``tools`` or ``integrations`` directly
(T-4 layering audit, issue #3352), so this module mirrors
:mod:`platform.scheduling.scheduler.investigation_runner`: the scheduler calls
