...
from platform.scheduling.scheduler.loop_constants import (
    LOOP_CHANNELS_PARAM,
    LOOP_SLACK_CHAT_ID_PARAM,
    LOOP_TELEGRAM_CHAT_ID_PARAM,
)
from platform.scheduling.scheduler.operation_log import record_scheduler_execution_operation
from platform.scheduling.scheduler.tasks import build_message
from platform.scheduling.scheduler.types import Provider, ScheduledTask, TaskKind, TaskStatus
...
def _deliver_slack(task: ScheduledTask, message: str) -> tuple[bool, str, str]:
    ...
    from platform.scheduling.scheduler.delivery import slack_can_deliver
...
def _deliver_interactive_shell(task: ScheduledTask, message: str) -> tuple[bool, str, str]:
    ...
    try:
        from platform.scheduling.scheduler.local_delivery import record_loop_message
