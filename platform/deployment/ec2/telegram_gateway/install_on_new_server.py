...
(:mod:`platform.deployment.ec2.telegram_gateway.build_server_image`) so later servers start
...
from platform.deployment.ec2.ssm import run_ssm_shell_command, wait_for_ssm_registration
