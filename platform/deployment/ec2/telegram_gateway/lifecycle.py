...
from platform.deployment.ec2.config import (
    DEFAULT_REGION,
...
from platform.deployment.ec2.ec2 import (
...
from platform.deployment.ec2.prep_ec2_deployment import (
    run_lifecycle_main,
    validate_deploy_env,
)
from platform.deployment.ec2.ssm import wait_for_ssm_registration
from platform.deployment.ec2.telegram_gateway.build_server_image import build_server_image
from platform.deployment.ec2.telegram_gateway.install_on_new_server import (
    destroy_installed_server,
    install_on_new_server,
)
from platform.deployment.ec2.telegram_gateway.provision import (
    provision_gateway_via_ssm,
    wait_for_gateway_ready,
)
from platform.deployment.ec2.telegram_gateway.stack import (
    ami_id_exists,
    delete_outputs,
    get_stack,
    load_ami_id,
