...
1. **Cycles** — module-load SCCs (:mod:`scripts.check_import_cycles`)
2. **Layers** — ``config`` independence via import-linter (``.importlinter``)
3. **Direct edges** — forbidden top-level imports (:mod:`scripts.check_direct_imports`)
...
from scripts.check_direct_imports import main as check_direct_imports  # noqa: E402
from scripts.check_import_cycles import main as check_import_cycles  # noqa: E402
