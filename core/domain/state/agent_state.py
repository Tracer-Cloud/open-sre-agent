...
:mod:`core.domain.state.runtime_slices` and chat slice from
:mod:`core.domain.state.slices`; the runtime dict remains flat.
...
from core.domain.state.types import AgentMode, ChatMessageModel
...
class AgentState(
    ...
    See :mod:`core.domain.state.runtime_slices` for investigation field groupings.
    """
