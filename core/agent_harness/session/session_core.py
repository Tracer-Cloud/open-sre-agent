...
if TYPE_CHECKING:
    ...
    from core.agent_harness.session.integration.state import IntegrationResolutionResult
else:
    GroundingContext = Any

from config.llm_reasoning_effort import ReasoningEffortChoice
from core.agent_harness.accounting.token_usage import TokenUsage
from core.agent_harness.session.integration.state import IntegrationState
