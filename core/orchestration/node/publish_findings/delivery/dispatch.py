...
def dispatch_report(
    ...
    *,
    ...
    """
    from utils.slack_delivery import build_action_blocks
...
def _dispatch_telegram(
    ...
    from utils.telegram_delivery import send_telegram_report
...
def _dispatch_whatsapp(
    ...
    from utils.whatsapp_delivery import send_whatsapp_report
