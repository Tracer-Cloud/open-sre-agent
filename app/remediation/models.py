...
class RemediationActionType(StrEnum):
    ...
    kubectl_describe_deployment = "kubectl_describe_deployment"
    ...
    aws_describe_rds_instance = "aws_describe_rds_instance"
...
SAFETY_BY_ACTION_TYPE: dict[RemediationActionType, SafetyLevel] = {
    ...
    RemediationActionType.kubectl_describe_deployment: SafetyLevel.safe,
    ...
    RemediationActionType.aws_describe_rds_instance: SafetyLevel.safe,
