...
Prebuilt Linux releases require glibc **2.35 or newer** (for example, Ubuntu 22.04+). The installer checks this before downloading. On older or non-glibc systems, install from source with `uv` or use Docker.
