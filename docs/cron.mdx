...
| `--provider` | Yes | Messaging provider: `telegram`, `slack`, `discord`, `rocketchat`, `mattermost` |
...
3. **Environment variables** — `TELEGRAM_BOT_TOKEN`, `SLACK_BOT_TOKEN`, `DISCORD_BOT_TOKEN`, `ROCKETCHAT_*`, `MATTERMOST_*`
