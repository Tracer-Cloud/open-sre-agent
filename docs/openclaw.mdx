...
- `tests/e2e/openclaw/test_openclaw_e2e.py`
...
- `OpenClaw bridge validation failed: Node.js ... is required`: switch the current shell to Node `22.12+` or newer, then re-run `openclaw --help` before retrying onboarding.
