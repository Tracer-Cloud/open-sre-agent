...
| **Hosted (OpenSRE Cloud)** | Org-wide connectors shared across users | OpenSRE Cloud web app at [app.tracer.cloud](https://app.tracer.cloud) |
...
Enterprise connectors are configured through the OpenSRE Cloud web app at [app.tracer.cloud](https://app.tracer.cloud). Once connected, they are available to all users in your organization.
