...
- Event enum: `platform_services/analytics/events.py`
- Capture helpers and KPI query specs: `platform_services/analytics/cli.py`
- Provider type constraints and coercion: `platform_services/analytics/provider.py`
