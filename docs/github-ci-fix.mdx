...
7. It verifies the exact pushed commit, waits for checks from applicable workflows,
   and reports whether they passed, failed, were superseded by another push, or
