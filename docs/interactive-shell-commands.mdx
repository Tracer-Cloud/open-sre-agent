...
| Security remediation request | Can launch a local coding agent to fix GitHub code-scanning alerts and open a pull request **elevated** |
...
| "fix all code scanning security issues and open a PR" | Local coding agent fixes alerts and opens a PR **elevated** |
