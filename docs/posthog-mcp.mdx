...
This is distinct from the [PostHog bounce-rate integration](/posthog), which is a narrow REST client used for watchdog alerting. Use the MCP integration when you want the agent to explore PostHog data directly.
