...
| **`gather_tool_evidence` → shared `AgentHarness`** | A bounded ReAct loop queries registered tools (Sentry, GitHub, PostHog, etc.) to ground a conversational answer | **Completely unobserved** |
