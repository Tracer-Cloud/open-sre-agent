...
- An onboard wizard to pick your LLM provider
...
1. **An LLM provider** — Claude Code, OpenAI, OpenRouter, or another supported provider
2. **A model and credential** — an API key, CLI login, or local endpoint depending on the provider
