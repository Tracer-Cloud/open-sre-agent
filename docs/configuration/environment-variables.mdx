...
| `POSTHOG_BOUNCE_WINDOW` | `24h` | Time window to query for calculating the bounce rate; format `<number><unit>` where unit is `s`, `m`, `h`, `d`, or `w` (e.g. `24h`, `7d`) | `integrations/posthog` |
