...
| `OPENSRE_REMOTE_SYNC_EXCLUDE` |  | Comma-separated glob patterns to keep off the store. See [Exclude paths](#exclude-paths) in remote-sync.mdx | `config/constants/filestorage` |
