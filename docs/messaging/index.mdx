...
| [**Telegram**](/messaging/telegram) | Mobile-first and on-call rotations | ✅ DM text chat via `opensre gateway telegram` | `opensre onboard` or `opensre integrations setup telegram` | ~5 min |
