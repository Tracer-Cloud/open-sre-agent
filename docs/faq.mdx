...
<AccordionGroup>
  ...
  <Accordion title="Which deployment path is recommended?">
    ...
    For org-wide hosted connectors, use [Enterprise setup](/install-enterprise) in the
    OpenSRE Cloud web app at [app.tracer.cloud](https://app.tracer.cloud).
  ...
  <Accordion title="Which model providers are supported?">
    OpenSRE supports Anthropic, OpenAI, OpenRouter, TrustedRouter, Gemini, Bedrock, Azure OpenAI,
    and CLI-backed
