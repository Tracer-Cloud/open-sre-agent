...
def with_new_generation(
    ...
    # The passphrase is proved against the manifest before a new key is minted.
    # If the passphrase is wrong, the new key is never generated and the manifest
    # is unchanged: open_manifest fails to unwrap the active key and raises
