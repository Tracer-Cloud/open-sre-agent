...
class PythonExecutionTool(BaseTool):
    ...
    description = (
        ...
        "`psutil.virtual_memory()` for disk/memory. To check whether a host/port is reachable, "
        "use `socket.create_connection((host, port), timeout=3)` with `allow_network: true`. "
