...
_BASELINE_IGNORES: frozenset[str] = frozenset(
    {
        ...
        "integrations.mariadb.tools.mariadb_innodb_status_tool -> tools.utils.sql_wrapper",
        ...
        "integrations.mariadb.tools.mariadb_replication_tool -> tools.utils.sql_wrapper",
        "integrations.mariadb.tools.mariadb_slow_queries_tool -> tools.tool_decorator",
        "integrations.mariadb.tools.mariadb_slow_queries_tool -> tools.utils.sql_wrapper",
        "integrations.mariadb.tools.mariadb_status_tool -> tools.tool_decorator",
        "integrations.mariadb.tools.mariadb_status_tool -> tools.utils.sql_wrapper",
        ...
        "integrations.bitbucket.tools.bitbucket_commits_tool -> tools.tool_decorator",
        "integrations.bitbucket.tools.bitbucket_file_contents_tool -> tools.tool_decorator",
        "integrations.bitbucket.tools.bitbucket_search_code_tool -> tools.tool_decorator",
        "integrations.bitbucket.tools.bitbucket_search_code_tool -> tools.utils.code_host_unavailable",
        "integrations.telegram.tools.telegram_send_message_tool.delivery -> tools.watch_dog.alarms",
        "integrations.telegram.tools.telegram_send_message_tool.tool -> tools.base",
        "integrations.telegram.tools.telegram_send_message_tool.tool -> tools.tool_decorator",
        "integrations.tracer.tools.tracer_airflow_dag_tool -> tools.tool_decorator",
        "integrations.tracer.tools.tracer_airflow_metrics_tool -> tools.tool_decorator",
        "integrations.tracer.tools.tracer_batch_statistics_tool -> tools.tool_decorator",
        "integrations.tracer.tools.tracer_error_logs_tool -> tools.tool_decorator",
        "integrations.tracer.tools.tracer_error_logs_tool -> tools.utils.log_compaction",
        "integrations.tracer.tools.tracer_failed_jobs_tool -> tools.tool_decorator",
        "integrations.tracer.tools.tracer_failed_run_tool -> tools.tool_decorator",
        "integrations.tracer.tools.tracer_failed_tools_tool -> tools.tool_decorator",
        "integrations.tracer.tools.tracer_host_metrics_tool -> tools.tool_decorator",
        "integrations.tracer.tools.tracer_host_metrics_tool -> tools.utils",
        "integrations.tracer.tools.tracer_run_tool -> tools.tool_decorator",
        "integrations.tracer.tools.tracer_tasks_tool -> tools.tool_decorator",
        "integrations.twilio.tools.twilio_notify_tool -> tools.base",
        "integrations.github.tools.actions -> tools.tool_decorator",
        "integrations.github.tools.actions -> tools.utils.code_host_unavailable",
        "integrations.github.tools.actions -> tools.utils.github_helpers",
        "integrations.github.tools.commits -> tools.tool_decorator",
        "integrations.github.tools.commits -> tools.utils.github_helpers",
        "integrations.github.tools.file_contents -> tools.tool_decorator",
        "integrations.github.tools.file_contents -> tools.utils.code_host_unavailable",
        "integrations.github.tools.file_contents -> tools.utils.github_helpers",
        "integrations.github.tools.issues -> tools.tool_decorator",
        "integrations.github.tools.issues -> tools.utils.code_host_unavailable",
        "integrations.github.tools.issues -> tools.utils.github_helpers",
        "integrations.github.tools.repository -> tools._telemetry",
        "integrations.github.tools.repository -> tools.tool_decorator",
        "integrations.github.tools.repository -> tools.utils.github_helpers",
        "integrations.github.tools.repository_tree -> tools.tool_decorator",
        "integrations.github.tools.repository_tree -> tools.utils.github_helpers",
        "integrations.github.tools.search_code -> tools.tool_decorator",
        "integrations.github.tools.search_code -> tools.utils.code_host_unavailable",
        "integrations.github.tools.search_code -> tools.utils.github_helpers",
        "integrations.github.tools.work_status -> tools.tool_decorator",
        "integrations.github.tools.work_status -> tools.utils.github_helpers",
        "integrations.gitlab.tools.gitlab_commits_tool -> tools.tool_decorator",
        "integrations.gitlab.tools.gitlab_file_tool -> tools.tool_decorator",
        "integrations.gitlab.tools.gitlab_file_tool -> tools.utils.code_host_unavailable",
        "integrations.gitlab.tools.gitlab_mrs_tool -> tools.tool_decorator",
        "integrations.gitlab.tools.gitlab_pipelines_tool -> tools.tool_decorator",
        "integrations.aws.tools.aws_operation_tool -> tools.tool_decorator",
        "integrations.aws_lambda.tools.lambda_config_tool -> tools.tool_decorator",
        "integrations.aws_lambda.tools.lambda_errors_tool -> tools.tool_decorator",
        "integrations.aws_lambda.tools.lambda_inspect_tool -> tools.tool_decorator",
        "integrations.aws_lambda.tools.lambda_invocation_logs_tool -> tools.tool_decorator",
        "integrations.aws_lambda.tools.lambda_invocation_logs_tool -> tools.utils.compaction",
        "integrations.cloudtrail.tools.cloudtrail_events_tool -> tools.tool_decorator",
        "integrations.cloudwatch.tools.cloudwatch_batch_metrics_tool -> tools._telemetry",
        "integrations.cloudwatch.tools.cloudwatch_batch_metrics_tool -> tools.tool_decorator",
        "integrations.cloudwatch.tools.cloudwatch_batch_metrics_tool -> tools.utils.availability",
        "integrations.cloudwatch.tools.cloudwatch_batch_metrics_tool -> tools.utils.compaction",
        "integrations.cloudwatch.tools.cloudwatch_logs_tool -> tools._telemetry",
        "integrations.cloudwatch.tools.cloudwatch_logs_tool -> tools.tool_decorator",
        "integrations.ec2.tools.ec2_instances_by_tag_tool -> tools.tool_decorator",
        "integrations.ec2.tools.ec2_instances_by_tag_tool -> tools.utils.availability",
        "integrations.ec2.tools.ec2_instances_by_tag_tool -> tools.utils.aws_topology_helper",
        "integrations.elb.tools.elb_target_health_tool -> tools.tool_decorator",
        "integrations.elb.tools.elb_target_health_tool -> tools.utils.availability",
        "integrations.elb.tools.elb_target_health_tool -> tools.utils.aws_topology_helper",
        "integrations.rds.tools.rds_describe_instance_tool -> tools.tool_decorator",
        "integrations.rds.tools.rds_events_tool -> tools.tool_decorator",
        "integrations.s3.tools.s3_get_object_tool -> tools.tool_decorator",
        "integrations.s3.tools.s3_inspect_tool -> tools.tool_decorator",
        "integrations.s3.tools.s3_list_tool -> tools.tool_decorator",
        "integrations.s3.tools.s3_marker_tool -> tools.tool_decorator",
